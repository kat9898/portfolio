...
const Skills = (props: Props) => {
  return (
    <section ref={props.skillsRef} className="skillsContainer">
      <h2>Skills</h2>
      <p>
        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quibusdam voluptatum unde eius quo
        similique neque earum esse ex aspernatur aperiam tenetur, harum saepe qui maiores doloremque
        eum, atque aliquid. Atque!
      </p>
              ...
              <div className="box">
                <svg className="skillCircle">
                  ...
                  <circle
                    ...
                    stroke="url(#gradient)"
                    strokeDasharray="500"
                    strokeDashoffset={`calc(480 - (440 * ${skill.level}) / 100)`}></circle>
                </svg>
